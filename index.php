		...
		<!-- Main -->
			...
			<div id="main">
				...
				<!-- Thumbnail -->
					...
					<section id="thumbnails" itemscope itemtype="http://schema.org/ImageGallery">
						...
						<article itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">

							<a itemprop="contentUrl" class="thumbnail" href="<?php echo $large_image_url[0] ?>" data-position="left center"><img itemprop="thumbnail" src="<?php echo $small_image_url[0] ?>" alt="<?php echo the_title_attribute( array( 'echo' => 0 ) ) ?>" /></a>

							<h2 itemprop="name"><?php the_title() ?></h2>

							<p itemprop="caption description"><?php the_excerpt() ?></p>
